...
const CartPage = ({ cartItems, handleUpdateQuantity, handleRemoveItem }) => {
  ...
  const handleProceedToCheckout = () => {
    ...
    setTimeout(() => {
      ...
      toast.success("Pesanan berhasil dibuat! Silakan lanjutkan pembayaran.", { id: 'checkoutToast' });

      // Kosongkan keranjang setelah pesanan dibuat
      handleUpdateQuantity(null, 0); // Cara untuk mengosongkan keranjang, jika handleUpdateQuantity bisa menerima null/0

      // Redirect ke halaman ProdukHistory.jsx
      navigate("/customer/riwayat-pesanan"); // Sesuaikan path ini dengan rute di App.jsx Anda
