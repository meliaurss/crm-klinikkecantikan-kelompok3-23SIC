    ...
    <div className="mx-auto max-w-7xl px-4 py-4 sm:px-6 lg:px-8">
      <div className="flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-4">
          <Link
            to="/login"
            className="px-4 py-2 text-indigo-600 border border-indigo-600 rounded-md 
              hover:bg-indigo-50 transition-all duration-300 hover:shadow-md"
          >
            Login
          </Link>
          <Link
            to="/register"
            className="px-4 py-2 bg-gradient-to-r from-indigo-600 to-blue-500 text-white 
              rounded-md hover:brightness-110 shadow-md transition-all duration-300"
          >
            Register
          </Link>
        </div>
