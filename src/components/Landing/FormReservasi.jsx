        ...
        <div className="flex-1 w-full ">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              ...
              className="w-full bg-[#FF6F61] text-white font-semibold text-lg py-3 rounded-lg shadow-md transition-colors hover:bg-[#E65A52] tracking-wider mt-8 disabled:opacity-50 disabled:cursor-not-allowed"
            >
